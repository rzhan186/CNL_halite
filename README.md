...
- [QIIME2 Pipeline](#qiime2-pipeline)
  - [Importing Data](#1-importing-data)
  - [Summarizing Imported Data](#2-summarizing-imported-data)
  - [Sequence Quality Control and Feature Table Construction](#3-sequence-quality-control-and-feature-table-construction)
  - [Taxonomic classifications] (#Taxonomic classifications)
  - [Dealing with Controls](#4-dealing-with-controls)
  - [Genus-level Taxonomic Classifications](#5-genus-level-taxonomic-classifications)
- [GTotree Pipeline](#GTotree Pipeline)
	- [Download Representative Genomes from GTDB](#6-download-representative-genomes-from-gtdb)
  	- [Identify Hydrogenase Genes](#7-identify-hydrogenase-genes)
